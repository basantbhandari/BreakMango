...
public class ShareButton : MonoBehaviour
{
	...
	public IEnumerator ShareTextInAnroid()
	{
		...
		var shareSubject = "Break Mango";
		var shareMessage = "a game,  player need to break mango from tree with available stone\n\n" +
						   "https://play.google.com/store/apps/details?id=com.basant.yesicbap.breakmango";
